...
<head>
    <title>Code coverage report for tests/helpers/spawn-stub.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">tests/helpers</a> spawn-stub.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { type ExecutionContext } from 'ava'
&nbsp;
