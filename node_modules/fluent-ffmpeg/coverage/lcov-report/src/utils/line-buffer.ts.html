...
<head>
    <title>Code coverage report for src/utils/line-buffer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> line-buffer.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">23x</span>
<span class="cline-any cline-yes">34x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import EventEmitter from 'node:events'
&nbsp;
