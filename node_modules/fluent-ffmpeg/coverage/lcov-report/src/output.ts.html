...
<head>
    <title>Code coverage report for src/output.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> output.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.97% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>194/198</span>
            </div>
...
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-yes">18x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Writable } from 'node:stream'
&nbsp;
...
&nbsp;
      if (this.audio.filters) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        options.push('-filter:a', generateFilterChain(this.audio.filters))</span>
...
&nbsp;
      if (this.video.filters) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        options.push('-filter:v', generateFilterChain(this.video.filters))</span>
<span class="cstat-no" title="statement not covered" >      }</span>
&nbsp;
      // todo size filters
    }
