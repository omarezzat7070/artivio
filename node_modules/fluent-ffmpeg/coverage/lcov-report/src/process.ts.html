...
<head>
    <title>Code coverage report for src/process.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> process.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">86.93% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>153/176</span>
            </div>
...
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { spawn } from 'node:child_process'
&nbsp;
...
&nbsp;
  #validateOptions() {
    if (this.outputStream<span class="branch-0 cbranch-no" title="branch not covered" > &amp;&amp; this.captureStdout)</span> <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        "Cannot use 'captureStdout' when a stream output is present"</span>
...
&nbsp;
      if (this.inputStream) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        this.inputStream.pipe(child.stdin)</span>
<span class="cstat-no" title="statement not covered" >        this.inputStream.on('error', (err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          // TODO make a specific error type</span>
...
<span class="cstat-no" title="statement not covered" >        })</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        // Prevent stdin errors from bubbling up, ffmpeg will crash anyway</span>
<span class="cstat-no" title="statement not covered" >        child.stdin.on('error', () =&gt; {})</span>
<span class="cstat-no" title="statement not covered" >      }</span>
&nbsp;
      child.stderr.on('data', (data) =&gt; stderr.append(data.toString()))
&nbsp;
      if (this.outputStream) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >        child.stdout.pipe(this.outputStream)</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        this.outputStream.on('error', (err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          // TODO make a specific error type</span>
<span class="cstat-no" title="statement not covered" >          reject(err)</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          child.kill()</span>
