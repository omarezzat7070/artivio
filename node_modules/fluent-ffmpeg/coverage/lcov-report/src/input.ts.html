...
<head>
    <title>Code coverage report for src/input.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> input.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-yes">21x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Readable } from 'node:stream'
&nbsp;
